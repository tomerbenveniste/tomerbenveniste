...
3rd-year Electrical & Computer Engineering student at Ben-Gurion University of the Negev, specializing in Computers and Communications.
...
- **Languages:** Python, MATLAB, Assembly (MSP430), C/C++ (currently pursuing)
- **Tools & Environments:** Linux CLI, Azure DevOps, XML configuration, database management
- **Domains:** Signal processing, numerical methods, OOP design, QA & testing
